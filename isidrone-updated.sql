...
CREATE TABLE `address` (
  ...
  `appt` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'Appartment number',
...
CREATE TABLE `category` (
  ...
  `name` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'The name of the category',
  `description` varchar(150) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'Description for the category',
...
INSERT INTO `category` VALUES (1,'Tous',NULL,0,1),(2,'Avec Caméra',NULL,1,1),(3,'Récréatif',NULL,2,1),(4,'Performance',NULL,3,1),(5,'Matériaux',NULL,4,1);
...
CREATE TABLE `featured_product` (
  ...
  CONSTRAINT `fk_product_product` FOREIGN KEY (`product`) REFERENCES `product` (`id`)
...
CREATE TABLE `order_info` (
  ...
  CONSTRAINT `fk_order_order_info` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product` (
  ...
  `price` decimal(10,2) DEFAULT NULL,
  `serialNumber` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `imgName` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `user` VALUES (1,'Test','test','test@mail.com','d5b4f7d2f7c345d6c810820ce250e7699ce78e45',1,1);
...
-- Dump completed on 2020-02-03 19:46:42
