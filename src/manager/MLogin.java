...
public class MLogin {
	...
	public static User login(String id, String password) {
		...
		try {
			...
			String query = "SELECT user.id, user.lastName, user.firstName, user.email, user.password,user.role_id,"
			...
			if(rs.next()) {
				address = new Address(rs.getInt(7), rs.getString(8), rs.getString(9), rs.getString(10),
						rs.getString(11), rs.getString(12), rs.getString(13), rs.getString(14));
				user = new User(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), address,rs.getInt(6));
			}	
